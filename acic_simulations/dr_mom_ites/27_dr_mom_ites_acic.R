...
dir_path <- "~/Documents/GitHub/CML_ATE_HTE/acic_simulations/dr_mom_ites/"
functions_path <- "~/Documents/GitHub/CML_ATE_HTE/functions/" 
data_path <- "~/Documents/GitHub/CML_ATE_HTE/acic_simulations/data_simulations/" 
ML_parameters <- "~/Documents/GitHub/CML_ATE_HTE/globals_parameters.R"
