...
source("~/Documents/GitHub/CML_ATE_HTE/functions/output_hte_ge_simulation.R")
source("~/Documents/GitHub/CML_ATE_HTE/functions/output_dml_simulation.R")

setwd("~/Documents/GitHub/CML_ATE_HTE/acic_simulations/output")

# Initialize results output -----------------------------------------------

analyze <- seq(77) #specifiy knobs 
knobs_all <- read.csv("~/Documents/GitHub/CML_ATE_HTE/acic_simulations/knobs_all.csv", sep=";")
knobs <- knobs_all[analyze,] 

names_methods <- c("OLS","DML Lasso", "DML Trees", "DML Boost", "DML RF","DML Nnet", "DML BART", "Causal Forest", "GML Lasso" ,"GML Trees" ,"GML Boost","GML RF","GML Nnet", "GML BART", "BART MC") #methods that are used to estimate the ATE
...
for(k in analyze){
  ...
  load(paste("~/Documents/GitHub/CML_ATE_HTE/acic_simulations/data_simulations/acic_",k,"_data.RData", sep="",collapse = NULL))
  ...
  #load DML output
  load(paste("~/Documents/GitHub/CML_ATE_HTE/acic_simulations/dml/",k,"_dml_acic.RData", sep="",collapse = NULL))
  ...
  load(paste("~/Documents/GitHub/CML_ATE_HTE/acic_simulations/cf/",k,"_cf_acic_results.RData", sep="",collapse = NULL))
  ate_cf_o <- rep(0,rep)
  ...
  load(paste("~/Documents/GitHub/CML_ATE_HTE/acic_simulations/generic/",k,"_generic_acic.RData", sep="",collapse = NULL))
  ...
  load(paste("~/Documents/GitHub/CML_ATE_HTE/acic_simulations/bart_mc/",k,"_bart_acic_results.RData", sep="",collapse = NULL))
